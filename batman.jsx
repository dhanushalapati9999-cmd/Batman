...
export default function BatmanTracker() {
  ...
  const C = {
    ...
    textP: "#D4C9B8", textS: "#6A6456", textM: "#2C2A26",
  };
      ...
      <div style={{ border: `1px solid ${C.border}`, padding: "16px 18px" }}>
        ...
        {["Keep your word. Always.",
          ...
          <div key={i} style={{ display: "flex", gap: 12, marginBottom: 8, alignItems: "flex-start" }}>
            ...
            <div style={{ ...serif, fontSize: 13, color: "#4A4538", lineHeight: 1.6 }}>{rule}</div>
          </div>
        ))}
      </div>
    </div>
          ...
          {HABITS.filter(h => h.group === g).map(h => {
            ...
            return (
              <div key={h.id} onClick={() => toggleHabit(h.id)}
                ...
                <div style={{ ...serif, fontSize: 14, color: done ? C.textS : "#3A3630",
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {[
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "8px 0",
            ...
            <div style={{ ...serif, fontSize: 13, color: s.done ? C.textS : "#3A3630",
    ...
    return (
      <div style={{ padding: "24px 20px" }}>
              ...
              {items.map(m => {
                ...
                return (
                  <div key={m.id} onClick={() => toggleMission(m.id)}
                    ...
                    <div style={{ ...serif, fontSize: 13, color: done ? C.textS : "#3A3630",
        ...
        <div style={{ border: `1px solid ${C.border}`, padding: "16px 18px", marginTop: 8 }}>
          ...
          <div style={{ ...serif, fontSize: 13, color: "#3A3630", lineHeight: 1.8, fontStyle: "italic" }}>
              ...
              return (
                <div key={book.id} onClick={() => toggleBook(book.id)}
                  style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                    ...
                    transition: "all 0.2s" }}>
                  <div>
                    <div style={{ ...serif, fontSize: 14, color: status === "done" ? C.textS : "#3A3630",
    ...
    return (
      <div style={{ padding: "24px 20px" }}>
        ...
        <div style={{ marginTop: 24, border: `1px solid ${C.border}`, padding: "14px 16px" }}>
          ...
          <div style={{ ...serif, fontSize: 13, fontStyle: "italic", color: "#2E2C28", lineHeight: 1.8 }}>
